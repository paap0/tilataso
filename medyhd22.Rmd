...
table1 = KreateTableOne(x=mediso, strata="OUT_SOW_mort_dic", factorVars=colnames(medcati))

table2 = KreateTableOne(x=mediso, strata="OUT_SOW_cull_dic")
...
Red > median mortality
Green < median mortality
...
Orange > median culling
Green < median culling
...
table1 = KreateTableOne(x=dfalc, strata="OUT_SOW_mort_dic", factorVars=colnames(medmca[,1:31]))

table2 = KreateTableOne(x=dfalc, strata="OUT_SOW_cull_dic",factorVars=colnames(medmca[,1:31]))
